...
# print(
#     os.path.exists("D:\Curso Progrmação\Portifolio\Portifolio\Python - Udemy")
# )  # Verifica se o caminho existe
# print(os.path.abspath("."))  # Retorna o caminho absoluto do arquivo
print(os.path.basename(diretorio))  # Retorna o nome do arquivo
